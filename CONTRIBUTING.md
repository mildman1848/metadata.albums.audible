...
| File                                    | Purpose                                           |
| --------------------------------------- | ------------------------------------------------- |
| `metadata.albums.audible/`              | Kodi scraper addon payload                        |
| `metadata.albums.audible/audible.xml`   | Kodi scraper URL/result/detail mapping            |
| `metadata.albums.audible/resources/`    | Settings, i18n files and translations             |
...
- `xmllint --noout metadata.albums.audible/addon.xml metadata.albums.audible/audible.xml metadata.albums.audible/resources/settings.xml`
